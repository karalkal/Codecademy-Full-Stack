...
const trainNetwork = new Graph(true, true);     // weighted and directed
...
// remove the route from New York to Denver, all the routes to and from Calgary, and the Calgary station.
